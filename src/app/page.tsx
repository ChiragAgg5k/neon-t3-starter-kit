      ...
      <header className="sticky top-0 z-50 bg-background/80 backdrop-blur">
        <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
          <Link href="#" className="flex items-center gap-2" prefetch={false}>
            ...
            <span className="font-bold">Neon T3 Starter Kitr</span>
          </Link>
        ...
        <section className="bg-gradient-to-r from-primary to-primary-foreground py-20 text-primary-foreground">
          <div className="container mx-auto flex flex-col items-center justify-center gap-6 px-4 md:px-6 lg:flex-row lg:gap-12">
            <div className="max-w-2xl text-center lg:text-left">
              ...
              <p className="mt-4 text-lg">Get started with a feature-rich, production-ready Neon T3 starter kit.</p>
        ...
        <section id="features" className="py-20">
          <div className="container mx-auto px-4 md:px-6">
            <div className="mb-12 text-center">
              ...
              <p className="mt-4 text-muted-foreground">Discover the powerful features of this Neon T3 starter kit.</p>
            </div>
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <Card>
                <CardContent className="flex flex-col items-center justify-center gap-4 p-6">
                  ...
                  <p className="text-muted-foreground">Easily customize the starter kit to fit your specific needs.</p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center justify-center gap-4 p-6">
        ...
        <section id="benefits" className="bg-muted py-20">
          <div className="container mx-auto px-4 md:px-6">
            <div className="mb-12 text-center">
              ...
              <p className="mt-4 text-muted-foreground">Discover the advantages of using our Next.js starter kit.</p>
            </div>
            <BenefitsComponent />
          </div>
        </section>
        <section id="pricing" className="py-20">
          <div className="container mx-auto px-4 md:px-6">
            <div className="mb-12 text-center">
              ...
              <p className="mt-4 text-muted-foreground">Choose the plan that best fits your needs.</p>
            </div>
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <Card>
        ...
        <section id="contact" className="bg-muted py-16">
          <div className="container mx-auto px-4 md:px-6">
            <div className="mb-12 text-center">
              ...
              <p className="mt-4 text-muted-foreground">Get in touch with our team for more information.</p>
            </div>
            <div className="mx-auto max-w-xl">
              <form className="space-y-4 bg-background/80 backdrop-blur p-6 rounded-xl">
                <div>
